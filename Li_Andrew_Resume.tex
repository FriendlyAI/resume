...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingTwo
      {Software Engineering Intern / Capital One Financial}{June 2022 - August 2022}
      \resumeItemListStart
        \resumeItem{Built a comprehensive web app unifying disparate types of cybersecurity information including events, threats, and knowledge bases}
        \resumeItem{Engaged in daily meetings to showcase progress and discuss design ideas with project managers}
        \resumeItem{Presented project to the Capital One cyber department}
      \resumeItemListEnd
